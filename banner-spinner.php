 ...
 *this action is documented in includes/class-banner-spinner-activator.php
**/
 ...
 * This action is documented in includes/class-banner-spinner-uninstaller.php
 */
function deactivate_plugin_main()
{
	require_once plugin_dir_path(__FILE__) . 'includes/class-plugin-main-deactivator.php';
	Hogo\Spinner\Deactivator::getInstance()->run();
}
